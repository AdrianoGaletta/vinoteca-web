      ...
      <div style={{ width: '100%', maxWidth: '420px' }}>
        ...
        {state?.success ? (
          <div style={{ background: '#1a2e1a', border: '1px solid #2d5a2d', borderRadius: '8px', padding: '1.5rem', color: '#4caf50', textAlign: 'center' }}>
            <p>{state.success}</p>
            <Link href="/auth/login" style={{ color: 'var(--dorado)', textDecoration: 'none', fontSize: '0.9rem', display: 'inline-block', marginTop: '1rem' }}>
          ...
          <form action={action} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
            ...
            <p style={{ textAlign: 'center', margin: 0 }}>
              <Link href="/auth/login" style={{ color: '#888', fontSize: '0.88rem', textDecoration: 'none' }}>
                ← Volver al inicio de sesión
              </Link>
            </p>
          </form>
